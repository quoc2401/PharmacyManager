    ...
    <div className='flex flex-col bg-white w-[250px] rounded-md m-4 overflow-hidden p-1'>
      ...
      <div className='p-2'>
        <div className='flex items-center h-[48px]'>
          <h3 className='font-medium line-clamp-2'>Ten thuoc Ten thuoc Ten thuoc Ten thuoc Ten thuoc Ten thuoc Ten thuoc Ten thuoc</h3>
        ...
        <div className='flex items-end justify-between'>
          <InputNumber 
            ...
            style={{ height: '32px' }}
            inputStyle={{ width: '42px', fontSize: '14px', paddingLeft: '8px', paddingRight: '8px' }}
          />
