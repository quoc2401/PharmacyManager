...
export const newDialogFooter = (saveAction: MouseEventHandler, cancelAction:MouseEventHandler) => {
    return (
      <>
        <Button label="Create" icon="pi pi-plus" className="rounded-md mr-2" onClick={saveAction} />
